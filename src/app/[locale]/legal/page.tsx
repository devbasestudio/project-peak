        ...
        <article className="grid gap-12 py-14 lg:grid-cols-[.7fr_1.3fr] lg:py-24">
          ...
          <div className="border-t border-charcoal/15" lang={mm ? "my" : "en"}>
            {[
              ...
              ["03", mm ? "Payment နဲ့ refund" : "Payment and refunds", mm ? "Payment ကို purchase reference နှင့် account email ဖြင့် manual verify လုပ်ပါသည်။ Screenshot တင်စရာမလိုပါ။ Digital program access ဖွင့်ပြီးနောက် refund မပေးနိုင်ပါ။ Payment မှားယွင်းမှုရှိပါက access မဖွင့်မီ @wayneax21 သို့ဆက်သွယ်ပါ။" : "KPay payments are verified manually using the purchase reference and account email; no screenshot upload is required. Because this is digital content, purchases are non-refundable after access is activated. Contact @wayneax21 before activation if a payment was made in error."],
