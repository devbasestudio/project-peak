create index weekly_schedule_slots_program_day_idx
on public.weekly_schedule_slots(program_day_id);
...
drop trigger if exists workout_sessions_weekly_schedule_gate on public.workout_sessions;
create trigger workout_sessions_weekly_schedule_gate
before insert or update of status, program_id, day_number on public.workout_sessions
